...
public class GameButton implements Serializable, PlayerListener
{
	...
	public void setOnScreenRectangle(int left, int top, int right, int bottom)
	{
		this.onScreenRectangle = new Rect(left, top, right, bottom);
	}
	...
	public void removeMyEventListener(ButtonListener listener)
	{
